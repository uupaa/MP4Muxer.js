...
// --- class / interfaces ----------------------------------
var MP4Muxer = {
    "mux": MP4Muxer_mux, // MP4Muxer.mux(nalUnitObjectArray:NALUnitObjectArray):MP4BoxTreeObject
};

// --- implements ------------------------------------------
function MP4Muxer_mux(nalUnitObjectArray) { // @arg NALUnitObjectArray - [NALUnitObject, ...]
                                            // @ret MP4BoxTreeObject
    // NalUnitObjectArray は、NALUnit単位にUint8Arrayに区切られている状態。
    // [0x09, 0xF0] ならAUということが分かる
